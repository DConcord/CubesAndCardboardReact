...
const LoginModal = ({ onLogin }: Props) => {
  ...
  const showFido2AuthOption = !!Passwordless.configure().fido2;
  ...
  return (
    <>
      {signInStatus === "NOT_SIGNED_IN" && user ? (
          ...
          <div>
            <div className="passwordless-email-title">
              ...
              <p className="passwordless-flex passwordless-flex-vertical-buttons">
                ...
                <Button
                  className="passwordless-button passwordless-button-sign-in passwordless-button-outlined"
                  onClick={() =>
                    requestSignInLink({
                      username: user.username,
                    })
        ...
        !user && (
          <>
            ...
            >
              <label className="passwordless-input-label">Enter your e-mail address to sign in:</label>
              <input
      ...
      <div className="passwordless-flex">
        ...
        {lastError && (
          <>
            <div className="passwordless-error"></div>
